# See https://www.reddit.com/r/adventofcode/comments/zsct8w/comment/j193vp3/

import re


*grid, _, path = open("22.txt")
pos, dir = grid[0].index(".") * 1j, 1j
grid = {
    (x + y * 1j): c for x, l in enumerate(grid) for y, c in enumerate(l) if c in ".#"
}
